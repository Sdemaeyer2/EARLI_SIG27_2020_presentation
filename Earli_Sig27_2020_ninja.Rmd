...
$\rightarrow$ **.pink[Model 3] fits best **
...
- mixed effects finite mixture models are promising for this kind of data
  ...
  - _opens up many possibilities for follow-up research questons and analyses_
...
- other applications of .pink[(mixed effecdts) finite mixture models] when modelling process data?
